  ...
  var Preview = /*#__PURE__*/function (_preview2) {
    ...
    function Preview(contentType, config, observableUpdater) {
      ...
      _events.on("contentType:redrawAfter", function (args) {
        if (_this.element && _this.element.children.children) {
          var $element = (0, _jquery)(_this.element.children.children);
    ...
    _proto.onAfterRender = function onAfterRender(element) {
      ...
      //this.initSlider();
      this.initSliderOnClass();
    }

    _proto.initSliderOnClass = function initSliderOnClass() {
        var $sliderContainer = (0, _jquery)(this.element).find('.mx-auto.relative');
        if ($sliderContainer.length > 0 && this.appearance() === 'carousel') {
          $sliderContainer.slick(this.buildSlickConfig());
        }
      }
    /**
     * @inheritdoc
    ...
    _proto.initSlider = function initSlider() {
      if (this.element && this.appearance() === "carousel") {
        (0, _jquery)(this.element.children.children).slick(this.buildSlickConfig());
      }
    };

    _proto.destroySlider = function destroySlider() {
      (0, _jquery)(this.element.children.children).slick("unslick");
    }
    /**
